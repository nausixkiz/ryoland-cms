        ...
        <div class="col-3">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ __('Edit ' . $state->name . ' State') }}</h4>
                </div>
                <div class="card-body">
                    <form class="form form-horizontal" method="POST"
                          action="{{ route('location.states.update', $state->slug) }}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="name"
                                               ...
                                               placeholder="California" value="{{ old('name', $state->name) }}"
                                               required/>
                                        @error('name')
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="abbreviation"
                                               ...
                                               name="abbreviation"
                                               placeholder="CA" value="{{ old('abbreviation', $state->abbreviation) }}"
                                               required/>
                                        @error('abbreviation')
                                        <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                ...
                                <div class="mb-1">
                                    <div class="form-check form-switch">
                                        <input type="checkbox"
                                               ...
                                               @if(old('is_default')  == 'on' ||  $state->isDefault()) checked @endif/>
                                        ...
                                        <select class="select2 form-select @error('country') is-invalid @enderror"
                                            ...
                                            @foreach($countries as $country)
                                                <option value="{{ $country->slug }}"
                                                        @if(old('country') == $country->slug || $state->country->slug == $country->slug) selected @endif>{{ $country->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('country')
                                        <span class="invalid-feedback" role="alert">
