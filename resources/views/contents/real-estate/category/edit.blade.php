        ...
        <div class="col-6">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ __('Edit category for real estate') }}</h4>
                </div>
                <div class="card-body">
                    <form class="form form-horizontal" method="POST"
                          action="{{ route('real-estate.categories.update', $category->slug) }}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="mb-1">
                                    <div class="form-check form-switch">
                                        <input type="checkbox"
                                               ...
                                               @if(old('is_default')  == 'on' || $category->isDefault()) checked @endif/>
