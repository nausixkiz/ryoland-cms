                ...
                <div class="card-body border-bottom">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <select id="category-status" class="form-select select2 mb-md-0 mb-2 ">
                                <option value=""> Select Status</option>
                                @foreach(\App\Constants\StatusConst::LIST_STATUS as $status)
                                    <option value="{{ $status }}"><span
                                            class="text-capitalize">{{ ucwords($status) }}</span>
                                    </option>
                                @endforeach
                            </select>
                        </div>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="{{ route('real-estate.categories.edit', $item->slug) }}"
                                               class="dropdown-item">
                                            ...
                                            <form id="{{ 'delete-category-' . $item->slug }}"
                                                  action="{{ route('real-estate.categories.destroy', $item->slug) }}"
                                                  method="POST"
                                                  class="d-none" hidden>
                                                @method('DELETE')
                                                @csrf
    ...
    <script>
        (function (window, document, $) {
            ...
            $('#add-new-category').on('click', function () {
                window.location.href = '{{ route('real-estate.categories.create') }}';
            });
