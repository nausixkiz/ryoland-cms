...
@section('title', __('Edit Facility'))
        ...
        <div class="col-3">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ __('Edit facility') }}</h4>
                </div>
                <div class="card-body">
                    <form class="form form-horizontal" method="POST"
                          action="{{ route('real-estate.facilities.update', $facility->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-12">
                            ...
                            <x-form.select-status-component layoutStyle="" type="normal" :statusVal="old('status', $facility->status)"></x-form.select-status-component>
