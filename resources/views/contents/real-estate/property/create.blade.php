...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 col-12">
            <form class="form form-vertical repeater" method="POST" action="{{ route('real-estate.properties.store') }}"
                ...
                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 col-12">
                                            ...
                                            <input class="form-control @error('number_bedroom') is-invalid @enderror"
                                                   ...
                                                   name="number_bedroom" value="{{ old('number_bedroom') }}" required/>
                                        ...
                                        <div class="col-md-2 col-12">
                                            ...
                                            <input class="form-control @error('number_bathroom') is-invalid @enderror"
                                                   ...
                                                   name="number_bathroom" value="{{ old('number_bathroom') }}" required/>
                                        ...
                                        <div class="col-md-2 col-12">
                                            ...
                                            <input class="form-control @error('square') is-invalid @enderror"
                                                   ...
                                                   name="square" value="{{ old('square') }}" required/>
                                            @error('square')
                                            <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                                                ...
                                                                <div class="col-md-6 col-12">
                                                                    <div class="input-group">
                                                                        <input class="form-control"
                                                                               type="number"
                                                                               name="distance" aria-describedby="button-delete" required/>
                    ...
                    <div class="col-md-3 col-12">
                        ...
                        <x-form.select-status-component layoutStyle='vertical' type="moderation-status"
                                                        statusVal="{{ old('moderation-status') }}">
                        </x-form.select-status-component>
                        <div class="col-12">
                            <div class="card">
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mb-2">
                                        <x-form.feature-option-component isChecked="{{old('is_featured') == 'on' ? 'true' : 'false'}}">
                                        </x-form.feature-option-component>
                                    </div>
                                    <div class="mb-2">
                                        <x-form.never-expired-option-component isChecked="{{old('never_expired') == 'on' ? 'true' : 'false'}}">
                                ...
                                <div class="card-body">
                                    <select class="select2 form-select @error('investor') is-invalid @enderror"
                                        ...
                                        @foreach($projects as $item)
                                            <option value="{{ $item->slug }}"
                                                    @if(old('project') == $item->slug) selected @endif>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
