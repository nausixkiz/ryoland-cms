...
@section('content')
    <div class="row">
        <div class="col-md-12 col-12">
            <form class="form form-vertical" method="POST" action="{{ route('blos.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-3 col-12">
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <select class="select2-icon form-select @error('category') is-invalid @enderror"
...
@section('page-script')
    <script>
        (function (window, document, $) {
            ...
            function featherIconFormat(icon) {
