                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="icon"
                                               ...
                                               placeholder="fas fa-user" value="{{ old('icon', $category->icon) }}"
                                               required/>
                                        @error('icon')
                                        <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                ...
                                <div class="mb-1">
                                    <div class="form-check form-switch">
                                        <input type="checkbox"
                                               ...
                                               @if(old('is_featured')  == 'on' || $category->isFeatured()) checked @endif />
                                ...
                                <div class="mb-1">
                                    <div class="form-check form-switch">
                                        <input type="checkbox"
                                               ...
                                               @if(old('is_default')  == 'on'  || $category->default()) checked @endif/>
