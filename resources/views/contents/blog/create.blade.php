...
@section('content')
    <div class="row">
        <div class="col-md-12 col-12">
            <form class="form form-vertical" method="POST" action="{{ route('blogs.store') }}"
                ...
                thumbnail.change(function () {
                    ...
                    if (/^image/.test(files[0].type)) { // only image file
                        ...
                        reader.onloadend = function () {
                            $('#blog-thumbnail-text').text(thumbnail.val());
                            $('#blog-thumbnail-preview').attr('src', event.target.result);
                        }
                    }
                });
