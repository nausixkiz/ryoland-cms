...
{
    const BASE_FILTER_ENUM_ARRAY = 'base_filter_enum_array';
    const BASE_FILTER_ENUM_LABEL = 'base_filter_enum_label';
    const BASE_FILTER_ENUM_HTML = 'base_filter_enum_html';
    ...
    public static function toArray(bool $includeDefault = false): array
    {
        ...
        return apply_filters(self::BASE_FILTER_ENUM_ARRAY, $result, get_called_class());
    }
    ...
    public static function getLabel(?string $value): ?string
    {
        ...
        return apply_filters(self::BASE_FILTER_ENUM_LABEL, $label, get_called_class());
    }
    ...
    {
        return apply_filters(self::BASE_FILTER_ENUM_HTML, $this->value, get_called_class());
    }
}
