...
class CreateNewPropertyRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'facility.*.id'=> ['exists:r_e_facilities,id'],
            'facility.*.distance'=> ['integer', 'min:1'],
            ...
            'gallery.*' => ['required', 'image', 'mimes:jpg,jpeg,png,bmp'],
        ];
